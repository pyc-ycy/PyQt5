...
class MatrixWinTest(unittest.TestCase):
    ...
    def test_moveScrollBar(self):
        ...
        print('* 当执行self.form.ui.tequilaScrollBar.setValue(12) 后，ui.tequilaScrollBar.value() => ' + str(
            self.form.ui.tequilaScrollBar.value()))
        ...
        print('* 当执行self.form.ui.tequilaScrollBar.setValue(-1) 后，ui.tequilaScrollBar.value() => ' + str(
            self.form.ui.tequilaScrollBar.value()))
    ...
    def test_tripleSecSpinBox(self):
        ...
        print('* 当执行self.form.ui.tripleSecSpinBox.setValue(12) 后，ui.tripleSecSpinBox.value() => ' + str(
            self.form.ui.tripleSecSpinBox.value()))
        ...
        print('* 当执行self.form.ui.tripleSecSpinBox.setValue(-1) 后，ui.tripleSecSpinBox.value() => ' + str(
            self.form.ui.tripleSecSpinBox.value()))
